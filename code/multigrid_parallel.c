...

{
    ...
    fp=fopen("multigrid_parallel_data.txt", "wb");
    ...
    printf("data saved in multigrid_parallel_data.txt\n");
    fclose(fp);
    ...
    for (kk=0; kk<(solution_iter/2); kk++) 
    {
            ...
            
        {
                ...
                
            {
                ...
                newMatrix_coarse[(i*coarse_dim_with_boundary)+j] = (grid_coarse[((i-1)*coarse_dim_with_boundary)+j] + grid_coarse[((i+1)*coarse_dim_with_boundary)+j] + grid_coarse[(i*coarse_dim_with_boundary)+j-1] + grid_coarse[(i*coarse_dim_with_boundary)+j+1])*0.25;
            ...
            
        {
                ...
                
            {
                ...
                grid_coarse[(i*coarse_dim_with_boundary)+j] = (newMatrix_coarse[((i-1)*coarse_dim_with_boundary)+j] + newMatrix_coarse[((i+1)*coarse_dim_with_boundary)+j] + newMatrix_coarse[(i*coarse_dim_with_boundary)+j-1] + newMatrix_coarse[(i*coarse_dim_with_boundary)+j+1])*0.25;
