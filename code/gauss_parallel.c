...

{
    ...
    fp=fopen("gauss_parallel_data.txt", "wb");
    ...
    printf("data saved in gauss_parallel_data.txt\n");
    fclose(fp);
    ...
    for (kk=0; kk<solution_iter; kk++) 
    {
            ...
            
        {
                ...
                
            {
                ...
                grid_fine[(i*fine_dim_with_boundary)+j] = (grid_fine[((i-1)*fine_dim_with_boundary)+j] + grid_fine[((i+1)*fine_dim_with_boundary)+j] + grid_fine[(i*fine_dim_with_boundary)+j-1] + grid_fine[(i*fine_dim_with_boundary)+j+1])*0.25;
